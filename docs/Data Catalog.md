...
|---|---|---|
| Sales | Delara Behzad / BI Team | Maintain sales logic and KPI definitions |
...
|---|---|---|---|
| `1.0.0` | `2026-08-10` | Delara Behzad | Initial Data Catalog for Sales ETL / Data Warehouse project |
